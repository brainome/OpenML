...
# Compile time: Mar-19-2020 20:23:55
# Invocation: btc -server brain.brainome.ai Data/heart-h.csv -o Models/heart-h.py -v -v -v -stopat 85.03 -port 8100 -f QC -e 100
