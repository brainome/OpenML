...
# Compile time: Mar-20-2020 03:05:27
# Invocation: btc -server brain.brainome.ai Data/nomao.csv -o Models/nomao.py -v -v -v -stopat 97.52 -port 8100 -f NN -e 10 -target Class -cm {'1':0,'2':1}
