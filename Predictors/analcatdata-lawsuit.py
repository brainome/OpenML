...
# Compile time: Mar-19-2020 19:52:26
# Invocation: btc -server brain.brainome.ai Data/analcatdata-lawsuit.csv -o Models/analcatdata-lawsuit.py -v -v -v -stopat 99.24 -port 8100 -f QC -e 100
...
import numpy as np
energy_thresholds=np.array([34.42, 35.205, 37.11, 37.235, 37.64, 37.965, 38.8, 43.625, 44.07, 48.655, 48.72])
def eqenergy(rows):
