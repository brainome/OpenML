...
# Compile time: Feb-28-2020 13:24:54
# Invocation: btc Data/analcatdata-lawsuit.csv -o Models/analcatdata-lawsuit.py -v -v -v -stopat 99.24 -port 8090 -f QC -e 100
...
def classify(row):
    energy=eqenergy(row)
    energy_thresholds=[34.42, 35.205, 37.11, 37.235, 37.64, 37.965, 38.8, 43.625, 44.07, 48.655, 48.72]
    start_label=0
