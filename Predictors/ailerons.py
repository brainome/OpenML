...
# Compile time: Feb-28-2020 20:27:36
# Invocation: btc Data/ailerons.csv -o Models/ailerons.py -v -v -v -stopat 89.03 -port 8090 -e 9
...
def classify(row):
    ...
    o_0 = (0.013147134 * h_0)+ (0.368793 * h_1)+ (-2.2758954 * h_2)+ (-0.8542865 * h_3)+ (1.4710544 * h_4) + 4.191083
