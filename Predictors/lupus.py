...
# Compile time: Feb-28-2020 13:19:32
# Invocation: btc Data/lupus.csv -o Models/lupus.py -v -v -v -stopat 78.16 -port 8090 -f QC -e 100 -target STATUS -cm {'alive':1,'dead':0}
...
def classify(row):
    energy=eqenergy(row)
    energy_thresholds=[99.51499999999999, 99.945, 106.13, 113.435, 114.81, 115.32, 126.28, 128.8, 133.2, 145.04500000000002, 150.89499999999998, 158.295, 166.7, 183.23, 190.64, 203.95499999999998, 212.89499999999998]
    start_label=1
