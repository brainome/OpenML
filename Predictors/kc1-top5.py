...
# Compile time: Mar-19-2020 21:25:32
# Invocation: btc -server brain.brainome.ai Data/kc1-top5.csv -o Models/kc1-top5.py -v -v -v -stopat 95.86 -port 8100 -f QC -e 100
...
import numpy as np
energy_thresholds=np.array([76371.33048450001, 79145.435396, 163879.820106, 172840.0781235, 214084.33627899998, 232317.15337049996, 584883.722585, 600967.0656854999, 653078.1223505, 808650.8226579999, 1113747.7879634998])
def eqenergy(rows):
