...
# Compile time: Mar-19-2020 19:49:01
# Invocation: btc -server brain.brainome.ai Data/rabe-131.csv -o Models/rabe-131.py -v -v -v -stopat 100 -port 8100 -f QC -e 100
...
import numpy as np
energy_thresholds=np.array([4914.5, 5037.0, 5254.0, 5383.0, 5662.5, 5736.0, 5798.0, 5939.0, 5962.5, 6009.0, 6042.0, 6080.0, 6136.5, 6383.0, 6574.5, 6711.0, 6870.0, 6956.0, 7146.0])
def eqenergy(rows):
