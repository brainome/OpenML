...
# Compile time: Feb-28-2020 13:19:09
# Invocation: btc Data/rabe-131.csv -o Models/rabe-131.py -v -v -v -stopat 100 -port 8090 -f QC -e 100
...
def classify(row):
    energy=eqenergy(row)
    energy_thresholds=[4914.5, 5037.0, 5254.0, 5383.0, 5662.5, 5736.0, 5798.0, 5939.0, 5962.5, 6009.0, 6042.0, 6080.0, 6136.5, 6383.0, 6574.5, 6711.0, 6870.0, 6956.0, 7146.0]
    start_label=0
