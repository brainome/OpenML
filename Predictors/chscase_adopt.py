...
# Compile time: Mar-19-2020 19:48:56
# Invocation: btc -server brain.brainome.ai Data/chscase_adopt.csv -o Models/chscase_adopt.py -v -v -v -stopat 87.18 -port 8100 -f QC -e 100
...
import numpy as np
energy_thresholds=np.array([60791760.5, 184899361.0, 321992359.5, 767859843.5, 790733400.5, 1146340437.5, 1202891609.0, 1552438783.5, 1607402031.0, 2197127497.5, 2376523790.5, 2469080268.0, 2719729146.0, 3423498101.0, 3537115001.0, 3598388129.0, 3628775887.0, 3782002331.5, 4092190688.0])
def eqenergy(rows):
