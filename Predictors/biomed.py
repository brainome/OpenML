...
# Compile time: Mar-19-2020 20:21:49
# Invocation: btc -server brain.brainome.ai Data/biomed.csv -o Models/biomed.py -v -v -v -stopat 94.74 -port 8100 -f QC -e 100
# This source code requires Python 3.
#
"""
System Type:                        Binary classifier
Best-guess accuracy:                64.11%
Model accuracy:                     97.60% (204/209 correct)
Improvement over best guess:        33.49% (of possible 35.89%)
Model capacity (MEC):               43 bits
Generalization ratio:               4.74 bits/bit
Model efficiency:                   0.77%/parameter
System behavior
True Negatives:                     33.97% (71/209)
True Positives:                     63.64% (133/209)
False Negatives:                    0.48% (1/209)
False Positives:                    1.91% (4/209)
...
import numpy as np
energy_thresholds=np.array([11506.0, 16615.9, 21522.65, 26765.75, 31504.35, 36566.85, 41625.9, 47216.45, 51533.15, 56760.2, 61259.35, 61349.4, 61415.0, 61425.9, 61469.45, 61523.2, 61602.45, 66856.65, 71283.65, 71454.0, 81288.5, 81602.3, 81742.15, 86637.7, 91374.35, 91612.0, 91790.2, 96757.9, 101713.4, 101730.3, 101772.8, 101783.65, 102004.4, 106639.70000000001, 111316.95000000001, 111620.15, 111852.85, 116562.0, 842229162.5500001, 1684401282.4, 1684431551.85, 1684441537.45, 1684446538.0500002])
def eqenergy(rows):
