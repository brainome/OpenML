...
# Compile time: Feb-28-2020 21:25:40
# Invocation: btc Data/SpeedDating.csv -o Models/SpeedDating.py -v -v -v -stopat 87.1 -port 8090
...
def classify(row):
    ...
    o_0 = (-0.7119313 * h_0)+ (0.6564243 * h_1) + -6.195613
