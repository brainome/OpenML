...
# Compile time: Feb-28-2020 23:53:27
# Invocation: btc Data/file764d5d063390.csv -o Models/file764d5d063390.py -v -v -v -stopat 64.44 -port 8090 -f QC -e 100 -target class -cm {'0':0,'1':1}
