...
# Compile time: Feb-28-2020 15:41:25
# Invocation: btc Data/pc1-req.csv -o Models/pc1-req.py -v -v -v -stopat 70.94 -port 8090 -e 9
...
def classify(row):
    ...
    o_0 = (0.1880751 * h_0)+ (0.11834756 * h_1)+ (0.51512915 * h_2)+ (4.3725023 * h_3)+ (-1.2850101 * h_4) + 0.43597376
