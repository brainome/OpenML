...
# Compile time: Mar-20-2020 01:49:53
# Invocation: btc -server brain.brainome.ai Data/ipums-la-99-small.csv -o Models/ipums-la-99-small.py -v -v -v -stopat 93.86 -port 8100 -f QC -e 100
