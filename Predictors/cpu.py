...
# Compile time: Mar-19-2020 20:21:39
# Invocation: btc -server brain.brainome.ai Data/cpu.csv -o Models/cpu.py -v -v -v -stopat 100 -port 8100 -f QC -e 100
# This source code requires Python 3.
#
"""
System Type:                        Binary classifier
Best-guess accuracy:                74.64%
Model accuracy:                     100.00% (209/209 correct)
Improvement over best guess:        25.36% (of possible 25.36%)
...
import numpy as np
energy_thresholds=np.array([139381820.5, 149060752.0, 149065733.5, 149066730.0, 294989483.0, 587401660.0, 789869695.0, 1253284779.5, 1279487991.0, 1305699831.5, 1315039626.0, 1505618676.0, 1555886987.5, 1608042438.0, 1617529305.5, 1627012920.5, 1627014171.0, 1627029352.0, 1776357719.0, 2347256398.5, 2411950738.0, 2868620895.5, 2961632879.0, 3548172191.0, 3624275602.0, 3700394046.5, 3700394980.5, 3700396972.0, 3908483908.0])
def eqenergy(rows):
