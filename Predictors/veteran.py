...
# Compile time: Feb-28-2020 13:20:00
# Invocation: btc Data/veteran.csv -o Models/veteran.py -v -v -v -stopat 77.37 -port 8090 -f QC -e 100
...
def classify(row):
    energy=eqenergy(row)
    energy_thresholds=[101.0, 101.5, 114.0, 115.5, 124.5, 125.0, 125.0, 126.0, 134.0, 135.0, 135.5, 136.0, 139.0, 141.5, 143.5, 144.5, 145.0, 147.5, 148.0, 148.0, 148.0, 149.5, 151.0, 154.0, 157.5, 159.0, 159.5, 160.5, 164.0, 174.0]
    start_label=1
