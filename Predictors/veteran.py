...
# Compile time: Mar-19-2020 19:49:43
# Invocation: btc -server brain.brainome.ai Data/veteran.csv -o Models/veteran.py -v -v -v -stopat 77.37 -port 8100 -f QC -e 100
# This source code requires Python 3.
#
"""
System Type:                        Binary classifier
Best-guess accuracy:                68.61%
Model accuracy:                     77.37% (106/137 correct)
Improvement over best guess:        8.76% (of possible 31.39%)
Model capacity (MEC):               30 bits
Generalization ratio:               3.53 bits/bit
Model efficiency:                   0.29%/parameter
System behavior
True Negatives:                     57.66% (79/137)
True Positives:                     19.71% (27/137)
False Negatives:                    11.68% (16/137)
False Positives:                    10.95% (15/137)
True Pos. Rate/Sensitivity/Recall:  0.63
True Neg. Rate/Specificity:         0.84
Precision:                          0.64
F-1 Measure:                        0.64
False Negative Rate/Miss Rate:      0.37
...
import numpy as np
energy_thresholds=np.array([101.0, 101.5, 114.0, 115.5, 124.5, 125.0, 125.0, 126.0, 134.0, 135.0, 135.5, 136.0, 139.0, 141.5, 143.5, 144.5, 145.0, 147.5, 148.0, 148.0, 148.0, 149.5, 151.0, 154.0, 157.5, 159.0, 159.5, 160.5, 164.0, 174.0])
def eqenergy(rows):
