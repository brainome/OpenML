...
# Compile time: Feb-28-2020 13:19:49
# Invocation: btc Data/analcatdata_chlamydia.csv -o Models/analcatdata_chlamydia.py -v -v -v -stopat 97.00 -port 8090 -f QC -e 100
