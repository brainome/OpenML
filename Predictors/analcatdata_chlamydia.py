...
# Compile time: Mar-19-2020 19:49:35
# Invocation: btc -server brain.brainome.ai Data/analcatdata_chlamydia.csv -o Models/analcatdata_chlamydia.py -v -v -v -stopat 97.00 -port 8100 -f QC -e 100
...
Improvement over best guess:        19.00% (of possible 19.0%)
...
TRAINFILE="analcatdata_chlamydia.csv"
