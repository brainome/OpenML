...
# Compile time: Mar-19-2020 20:21:43
# Invocation: btc -server brain.brainome.ai Data/analcatdata-broadway.csv -o Models/analcatdata-broadway.py -v -v -v -stopat 100 -port 8100 -f QC -e 100
