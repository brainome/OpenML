...
# Compile time: Feb-28-2020 15:42:27
# Invocation: btc Data/analcatdata-broadway.csv -o Models/analcatdata-broadway.py -v -v -v -stopat 100 -port 8090 -f QC -e 100
