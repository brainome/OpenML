...
# Compile time: Feb-28-2020 13:19:37
# Invocation: btc Data/fruitfly.csv -o Models/fruitfly.py -v -v -v -stopat 64.8 -port 8090 -f QC -e 100
...
def classify(row):
    energy=eqenergy(row)
    energy_thresholds=[34.22, 43.21, 43.760000000000005, 44.760000000000005, 48.84, 50.349999999999994, 50.91, 51.76, 51.82, 52.8, 55.3, 56.3, 56.8, 58.29, 63.36, 64.30000000000001, 67.38, 69.42, 71.84, 71.84, 77.91, 78.38, 79.38, 80.87, 85.88, 89.36, 100.36, 105.9]
    start_label=1
