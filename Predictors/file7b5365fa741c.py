...
# Compile time: Mar-19-2020 23:54:51
# Invocation: btc -server brain.brainome.ai Data/file7b5365fa741c.csv -o Models/file7b5365fa741c.py -v -v -v -stopat 100 -port 8100 -f NN -e 10
...
def classify(row):
    ...
    o[0] = (-0.41971418 * h_0)+ (-0.7630783 * h_1) + 2.2355666
