...
# Compile time: Mar-19-2020 19:49:11
# Invocation: btc -server brain.brainome.ai Data/witmer-census-1980.csv -o Models/witmer-census-1980.py -v -v -v -stopat 78 -port 8100 -f QC -e 100
