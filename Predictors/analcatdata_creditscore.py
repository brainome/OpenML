...
# Compile time: Feb-28-2020 13:19:43
# Invocation: btc Data/analcatdata_creditscore.csv -o Models/analcatdata_creditscore.py -v -v -v -stopat 99.00 -port 8090 -f QC -e 100
