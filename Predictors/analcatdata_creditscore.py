...
# Compile time: Mar-19-2020 19:49:30
# Invocation: btc -server brain.brainome.ai Data/analcatdata_creditscore.csv -o Models/analcatdata_creditscore.py -v -v -v -stopat 99.00 -port 8100 -f QC -e 100
...
def classify(row):
    energy=eqenergy(row)
    if (energy>60.05500000000001):
        return 1.0
    if (energy>58.120000000000005):
        return 0.0
    if (energy>54.05):
        return 1.0
    if (energy>51.29):
        return 0.0
    if (energy>49.495000000000005):
        return 1.0
    if (energy>45.275000000000006):
        return 0.0
    if (energy>45.125):
        return 1.0
    if (energy>24.93):
