...
# Compile time: Feb-16-2020 14:00:25
# Invocation: btc -v -v analcatdata_creditscore-1.csv -o analcatdata_creditscore-1.py
# This source code requires Python 3.
#
"""
System Type:                        Binary classifier
Best-guess accuracy:                73.00%
Model accuracy:                     96.00% (96/100 correct)
Improvement over best guess:        23.00% (of possible 27.0%)
Model capacity (MEC):               11 bits
Generalization ratio:               8.72 bits/bit
Model efficiency:                   2.09%/parameter
System behavior
True Negatives:                     27.00% (27/100)
True Positives:                     69.00% (69/100)
...
Model bias:                         97.56% higher chance to pick class 1
"""
...
TRAINFILE="analcatdata_creditscore-1.csv"
...
def transform(X):
    ...
    if (transform_true):
        mean = np.array([29.86, 3.205999999999999, 179.42919999999998, 0.3, 0.06, 0.34])
        components = np.array([array([ 4.50396304e-03,  2.08294833e-03,  9.99987456e-01,  3.10869446e-04,
        2.19585339e-06, -6.05092768e-04]), array([ 9.95475773e-01,  8.80686584e-02, -4.66877645e-03,  3.25035517e-02,
        4.13423237e-04,  1.39085148e-02]), array([-0.08742089,  0.98116337, -0.00176097,  0.07900421,  0.05561925,
       -0.14261052])])
        whiten = False
        explained_variance = np.array([90684.53684656427, 44.091482170271725, 2.262064523083655])
        X = X - mean
...
def classify(row):
    x=row
    h_0 = max((((-4.192919 * float(x[0]))+ (2.134059 * float(x[1]))+ (10.90007 * float(x[2]))) + -15.978234), 0)
    h_1 = max((((0.28819057 * float(x[0]))+ (-0.67386156 * float(x[1]))+ (-1.3238264 * float(x[2]))) + 1.4752996), 0)
    o_0 = (-0.023192998 * h_0)+ (1.4419463 * h_1) + 15.80666
