...
# Compile time: Feb-28-2020 16:46:34
# Invocation: btc Data/GAMETES_Epistasis_3-Way_20atts_0.2H_EDM-1_1.csv -o Models/GAMETES_Epistasis_3-Way_20atts_0.py -v -v -v -stopat 62.82 -port 8090
...
def classify(row):
    ...
    o_0 = (25.59334 * h_0)+ (-0.31858036 * h_1)+ (-19.255882 * h_2)+ (4.220061 * h_3)+ (2.7063112 * h_4)+ (-4.444643 * h_5)+ (-53.025208 * h_6)+ (3.719667 * h_7)+ (-1.649567 * h_8)+ (-3.8364625 * h_9) + 2.7854517
