...
# Compile time: Mar-19-2020 21:25:43
# Invocation: btc -server brain.brainome.ai Data/meta.csv -o Models/meta.py -v -v -v -stopat 92.42 -port 8100 -f QC -e 100
