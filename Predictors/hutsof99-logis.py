...
# Compile time: Mar-19-2020 19:49:15
# Invocation: btc -server brain.brainome.ai Data/hutsof99-logis.csv -o Models/hutsof99-logis.py -v -v -v -stopat 77.14 -port 8100 -f QC -e 100
...
import numpy as np
energy_thresholds=np.array([33.8, 36.515, 40.36, 45.67, 49.72, 52.435, 54.67, 54.86, 56.465, 60.225, 64.52000000000001, 72.69, 79.535, 82.435, 84.41499999999999, 90.15, 96.605])
def eqenergy(rows):
