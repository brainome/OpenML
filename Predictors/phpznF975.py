...
# Compile time: Mar-20-2020 02:20:10
# Invocation: btc -server brain.brainome.ai Data/phpznF975.csv -o Models/phpznF975.py -v -v -v -stopat 95.99 -port 8100 -f QC -e 100
