...
# Compile time: Mar-19-2020 20:23:36
# Invocation: btc -server brain.brainome.ai Data/arsenic-female-lung.csv -o Models/arsenic-female-lung.py -v -v -v -stopat 99.11 -port 8100 -f QC -e 100
...
import numpy as np
energy_thresholds=np.array([253.5, 256.0, 793.0, 794.0, 895.5, 896.0, 1319.5, 1320.0, 1440.0, 1442.0, 1577.5, 1582.0, 49754.5])
def eqenergy(rows):
