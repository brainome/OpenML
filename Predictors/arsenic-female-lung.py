...
# Compile time: Feb-28-2020 15:45:19
# Invocation: btc Data/arsenic-female-lung.csv -o Models/arsenic-female-lung.py -v -v -v -stopat 99.11 -port 8090 -f QC -e 100
...
def classify(row):
    energy=eqenergy(row)
    energy_thresholds=[253.5, 256.0, 793.0, 794.0, 895.5, 896.0, 1319.5, 1320.0, 1440.0, 1442.0, 1577.5, 1582.0, 49754.5]
    start_label=0
