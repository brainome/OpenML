...
# Compile time: Feb-28-2020 16:43:13
# Invocation: btc Data/banknote-authentication.csv -o Models/banknote-authentication.py -v -v -v -stopat 100 -port 8090 -e 9 -target Class -cm {'1':0,'2':1}
...
def classify(row):
    x=row
    h_0 = max((((-17.959871 * float(x[0]))+ (-12.819212 * float(x[1]))+ (-12.554026 * float(x[2]))+ (-9.052928 * float(x[3]))) + 12.564416), 0)
    h_1 = max((((1.7855092 * float(x[0]))+ (-1.2554302 * float(x[1]))+ (-2.7432442 * float(x[2]))+ (0.9287056 * float(x[3]))) + 4.1665487), 0)
    h_2 = max((((2.749394 * float(x[0]))+ (0.25964254 * float(x[1]))+ (1.2627269 * float(x[2]))+ (-2.1149788 * float(x[3]))) + -0.040668957), 0)
    o_0 = (0.97068626 * h_0)+ (1.5626695 * h_1)+ (-2.2702417 * h_2) + -2.2960174
