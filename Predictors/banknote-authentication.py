...
# Compile time: Feb-18-2020 22:41:30
# Invocation: btc banknote-authentication-1.csv -o banknote-authentication-3.py -v -v -v -port 8090 -e 10 -cm {'1':0,'2':1}
...
TRAINFILE="banknote-authentication-1.csv"
...
def classify(row):
    x=row
    h_0 = max((((-15.1761265 * float(x[0]))+ (-11.135636 * float(x[1]))+ (-15.322904 * float(x[2]))+ (-5.4326973 * float(x[3]))) + 13.471039), 0)
    h_1 = max((((-0.41091284 * float(x[0]))+ (3.656163 * float(x[1]))+ (0.90999895 * float(x[2]))+ (0.21869214 * float(x[3]))) + 2.039652), 0)
    h_2 = max((((-7.005359 * float(x[0]))+ (-2.269771 * float(x[1]))+ (0.23789191 * float(x[2]))+ (9.588338 * float(x[3]))) + -0.08463687), 0)
    o_0 = (3.596585 * h_0)+ (-2.1365826 * h_1)+ (0.7382149 * h_2) + -5.9818153
