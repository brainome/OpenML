...
# Compile time: Mar-19-2020 21:25:27
# Invocation: btc -server brain.brainome.ai Data/banknote-authentication.csv -o Models/banknote-authentication.py -v -v -v -stopat 100 -port 8100 -f NN -e 10 -target Class -cm {'1':0,'2':1}
...
def classify(row):
    ...
    o[0] = (0.97068626 * h_0)+ (1.5626695 * h_1)+ (-2.2702417 * h_2) + -2.2960174
