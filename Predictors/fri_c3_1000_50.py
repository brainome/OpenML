...
# Compile time: Feb-28-2020 19:32:38
# Invocation: btc Data/fri_c3_1000_50.csv -o Models/fri_c3_1000_50.py -v -v -v -stopat 91.30 -port 8090 -e 9
...
def classify(row):
    ...
    o_0 = (4.5899224 * h_0)+ (2.561968 * h_1)+ (-5.476658 * h_2)+ (-8.328746 * h_3)+ (8.873351 * h_4)+ (10.356889 * h_5)+ (-7.3423114 * h_6) + -3.142574
