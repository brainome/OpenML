...
# Compile time: Feb-28-2020 13:19:14
# Invocation: btc Data/sleep.csv -o Models/sleep.py -v -v -v -stopat 77.42 -port 8090 -f QC -e 100
...
def classify(row):
    energy=eqenergy(row)
    energy_thresholds=[35.0625, 37.8115, 48.897499999999994, 49.938, 59.692499999999995, 67.05, 77.93, 121.0175, 201.39, 233.415, 244.54, 326.42999999999995, 384.1, 842.73, 968.1999999999999, 1216.3, 1395.8, 1612.5, 1702.0, 1684325063.841, 1684325089.2649999, 1684325099.18, 2526487639.475]
    start_label=0
