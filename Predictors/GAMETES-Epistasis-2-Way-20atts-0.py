...
# Compile time: Feb-28-2020 17:02:15
# Invocation: btc Data/GAMETES-Epistasis-2-Way-20atts-0.4H-EDM-1-1.csv -o Models/GAMETES-Epistasis-2-Way-20atts-0.py -v -v -v -stopat 80.56 -port 8090 -e 9
...
def classify(row):
    ...
    o_0 = (0.17684676 * h_0)+ (-0.555189 * h_1)+ (11.193332 * h_2)+ (1.262757 * h_3)+ (2.1791143 * h_4)+ (-2.8548398 * h_5) + -5.2796836
