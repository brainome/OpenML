...
# Compile time: Mar-20-2020 05:39:28
# Invocation: btc -server brain.brainome.ai Data/KDDCup09_appetency.csv -o Models/KDDCup09_appetency.py -v -v -v -stopat 98.22 -port 8100 -f QC -e 100 -target APPETENCY -cm {'-1':0,'1':1}
