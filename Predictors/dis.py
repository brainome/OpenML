...
# Compile time: Feb-28-2020 18:02:35
# Invocation: btc Data/dis.csv -o Models/dis.py -v -v -v -stopat 98.87 -port 8090 -e 9
...
def classify(row):
    ...
    o_0 = (0.45663664 * h_0)+ (0.72236013 * h_1) + -0.31603345
