...
# Compile time: Feb-28-2020 16:39:27
# Invocation: btc Data/sponge.csv -o Models/sponge.py -v -v -v -stopat 96.05 -port 8090 -f QC -e 100
...
def classify(row):
    energy=eqenergy(row)
    energy_thresholds=[110310442936.5, 110542670969.0, 111586943831.0, 111712863042.0, 113886065064.0, 113981002946.0, 115926971584.0, 116059968184.5, 117598763180.0, 117690550865.5]
    start_label=1
