...
# Compile time: Mar-19-2020 21:22:34
# Invocation: btc -server brain.brainome.ai Data/sponge.csv -o Models/sponge.py -v -v -v -stopat 96.05 -port 8100 -f QC -e 100
...
import numpy as np
energy_thresholds=np.array([110310442936.5, 110542670969.0, 111586943831.0, 111712863042.0, 113886065064.0, 113981002946.0, 115926971584.0, 116059968184.5, 117598763180.0, 117690550865.5])
def eqenergy(rows):
