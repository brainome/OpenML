...
# Compile time: Mar-19-2020 19:48:51
# Invocation: btc -server brain.brainome.ai Data/shuttle-landing-control.csv -o Models/shuttle-landing-control.py -v -v -v -stopat 80.00 -port 8100 -f QC -e 100 -target Class -cm {'1':0,'2':1}
...
def classify(row):
    energy=eqenergy(row)
    if (energy>7579462683.5):
        return 1.0
    if (energy>4210812606.0):
        return 0.0
    if (energy>2526487568.0):
        return 1.0
    if (energy>842162530.0):
        return 0.0
    if (energy>10.0):
        return 1.0
    if (energy>9.5):
