...
# Compile time: Feb-16-2020 12:48:55
# Invocation: btc -target Class -v -v shuttle-landing-control-1.csv -o shuttle-landing-control-1.py -f ME
...
System behavior
True Negatives:                     60.00% (9/15)
True Positives:                     33.33% (5/15)
...
TRAINFILE="shuttle-landing-control-1.csv"
