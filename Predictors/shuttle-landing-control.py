...
# Compile time: Feb-28-2020 13:18:57
# Invocation: btc Data/shuttle-landing-control.csv -o Models/shuttle-landing-control.py -v -v -v -stopat 80.00 -port 8090 -f QC -e 100 -target Class -cm {'1':0,'2':1}
