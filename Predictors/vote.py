...
# Compile time: Mar-19-2020 21:22:19
# Invocation: btc -server brain.brainome.ai Data/vote.csv -o Models/vote.py -v -v -v -stopat 96.78 -port 8100 -f NN -e 10
...
def classify(row):
    ...
    o[0] = (0.14084682 * h_0)+ (1.1045896 * h_1) + -3.6561852
