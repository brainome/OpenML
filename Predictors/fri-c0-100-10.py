...
# Compile time: Feb-28-2020 15:45:13
# Invocation: btc Data/fri-c0-100-10.csv -o Models/fri-c0-100-10.py -v -v -v -stopat 89 -port 8090 -e 9
...
def classify(row):
    ...
    o_0 = (2.1434612 * h_0)+ (-2.127234 * h_1)+ (-4.473231 * h_2) + 0.79304135
