...
# Compile time: Feb-16-2020 13:38:53
# Invocation: btc -v -v mv-1.csv -o mv-1.py
# This source code requires Python 3.
#
"""
System Type:                        Binary classifier
Best-guess accuracy:                59.65%
Model accuracy:                     99.88% (40721/40768 correct)
Improvement over best guess:        40.23% (of possible 40.35%)
Model capacity (MEC):               25 bits
Generalization ratio:               1628.84 bits/bit
Model efficiency:                   1.60%/parameter
System behavior
True Negatives:                     40.27% (16418/40768)
True Positives:                     59.61% (24303/40768)
False Negatives:                    0.04% (18/40768)
False Positives:                    0.07% (29/40768)
...
mappings = [{3499814433.0: 0, 1830392916.0: 1, 4200685455.0: 2}, {1978086825.0: 0, 1739204639.0: 1}, {562391268.0: 0, 1500195262.0: 1}]
...
def classify(row):
    x=row
    h_0 = max((((0.6171692 * float(x[0]))+ (-0.009722775 * float(x[1]))+ (-0.0022568281 * float(x[2]))+ (-0.0030764064 * float(x[3]))+ (0.009751295 * float(x[4]))+ (0.6187253 * float(x[5]))+ (-0.010546166 * float(x[6]))+ (20.87959 * float(x[7]))+ (8.204049e-06 * float(x[8]))+ (0.00064020813 * float(x[9]))) + 5.146236), 0)
    h_1 = max((((0.60069746 * float(x[0]))+ (0.22375667 * float(x[1]))+ (0.02993251 * float(x[2]))+ (0.7951152 * float(x[3]))+ (0.7360274 * float(x[4]))+ (-0.19802235 * float(x[5]))+ (-0.49952045 * float(x[6]))+ (-0.32156724 * float(x[7]))+ (-0.81987005 * float(x[8]))+ (-0.49260405 * float(x[9]))) + 0.040544655), 0)
    o_0 = (16.528517 * h_0)+ (-0.23234329 * h_1) + -8.295069
