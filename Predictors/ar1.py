...
# Compile time: Mar-19-2020 20:23:50
# Invocation: btc -server brain.brainome.ai Data/ar1.csv -o Models/ar1.py -v -v -v -stopat 93.39 -port 8100 -f QC -e 100
...
import numpy as np
energy_thresholds=np.array([1271.89, 1457.395, 1773.75, 1802.7299999999998, 2336.09, 2745.58, 10968.725000000002, 11270.835, 11734.045000000002, 13496.94, 15898.755000000001, 18688.705, 33164.565, 44940.92])
def eqenergy(rows):
