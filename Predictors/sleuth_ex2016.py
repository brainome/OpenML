...
# Compile time: Feb-28-2020 13:24:42
# Invocation: btc Data/sleuth_ex2016.csv -o Models/sleuth_ex2016.py -v -v -v -stopat 77.01 -port 8090 -f QC -e 100
...
def classify(row):
    energy=eqenergy(row)
    energy_thresholds=[460.8745, 462.258, 464.0765, 464.443, 465.969, 466.3615, 467.0725, 468.5395, 468.783, 469.06550000000004, 469.252, 469.96, 471.21449999999993, 471.412, 471.964, 472.183, 473.15299999999996, 475.5285, 478.9855, 481.9135, 482.8515]
    start_label=1
