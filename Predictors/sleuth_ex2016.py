...
# Compile time: Mar-19-2020 19:52:16
# Invocation: btc -server brain.brainome.ai Data/sleuth_ex2016.csv -o Models/sleuth_ex2016.py -v -v -v -stopat 77.01 -port 8100 -f QC -e 100
...
import numpy as np
energy_thresholds=np.array([460.8745, 462.258, 464.0765, 464.443, 465.969, 466.3615, 467.0725, 468.5395, 468.783, 469.06550000000004, 469.252, 469.96, 471.21449999999993, 471.412, 471.964, 472.183, 473.15299999999996, 475.5285, 478.9855, 481.9135, 482.8515])
def eqenergy(rows):
