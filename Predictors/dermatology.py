...
# Compile time: Feb-28-2020 16:05:19
# Invocation: btc Data/dermatology.csv -o Models/dermatology.py -v -v -v -stopat 100 -port 8090 -e 9
...
def classify(row):
    ...
    o_0 = (-0.8284108 * h_0)+ (-0.4285477 * h_1) + 3.4201646
