...
# Compile time: Feb-28-2020 19:17:02
# Invocation: btc Data/fri-c0-1000-50.csv -o Models/fri-c0-1000-50.py -v -v -v -stopat 88.6 -port 8090 -e 9
...
def classify(row):
    ...
    o_0 = (0.8545722 * h_0)+ (3.9127655 * h_1)+ (-5.9989 * h_2)+ (-8.002925 * h_3)+ (9.304098 * h_4) + -2.281166
