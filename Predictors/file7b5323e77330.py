...
# Compile time: Mar-20-2020 08:39:08
# Invocation: btc -server brain.brainome.ai Data/file7b5323e77330.csv -o Models/file7b5323e77330.py -v -v -v -stopat 91.25 -port 8100 -f QC -e 100
# This source code requires Python 3.
#
"""
System Type:                        Binary classifier
Best-guess accuracy:                99.97%
Model accuracy:                     100.00% (20000/20000 correct)
Improvement over best guess:        0.03% (of possible 0.03%)
Model capacity (MEC):               10 bits
Generalization ratio:               2000.00 bits/bit
Model efficiency:                   0.00%/parameter
System behavior
True Negatives:                     99.97% (19995/20000)
True Positives:                     0.03% (5/20000)
False Negatives:                    0.00% (0/20000)
False Positives:                    0.00% (0/20000)
...
import numpy as np
energy_thresholds=np.array([1698.6811070879999, 1698.69613482, 1747.84063970565, 1747.86849370565, 1824.5284746273, 1824.5466331470002, 1880.773906804, 1880.8203302945, 2211.833669447, 2211.919698265])
def eqenergy(rows):
