...
# Compile time: Mar-02-2020 04:53:21
# Invocation: btc Data/file7b5323e77330.csv -o Models/file7b5323e77330.py -v -v -v -stopat 91.25 -port 8090 -f QC -e 10
...
def classify(row):
    energy=eqenergy(row)
    energy_thresholds=[1698.6811070879999, 1698.69613482, 1747.84063970565, 1747.86849370565, 1824.5284746273, 1824.5466331470002, 1880.773906804, 1880.8203302945, 2211.833669447, 2211.919698265]
    start_label=1
