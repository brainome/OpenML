...
# Compile time: Feb-28-2020 13:24:36
# Invocation: btc Data/haberman.csv -o Models/haberman.py -v -v -v -stopat 78 -port 8090 -e 9 -target Survival_status -cm {'1':0,'2':1}
...
def classify(row):
    ...
    o_0 = (-0.039134104 * h_0)+ (0.028108943 * h_1) + -0.17635962
