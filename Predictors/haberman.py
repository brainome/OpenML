...
# Compile time: Mar-19-2020 19:52:11
# Invocation: btc -server brain.brainome.ai Data/haberman.csv -o Models/haberman.py -v -v -v -stopat 78 -port 8100 -f NN -e 10 -target Survival_status -cm {'1':0,'2':1}
...
Generalization ratio:               20.45 bits/bit
Model efficiency:                   0.00%/parameter
System behavior
True Negatives:                     73.53% (225/306)
True Positives:                     0.00% (0/306)
False Negatives:                    26.47% (81/306)
False Positives:                    0.00% (0/306)
...
def classify(row):
    ...
    h_0 = max((((0.4303459 * float(x[0]))+ (0.20547014 * float(x[1]))+ (0.08976394 * float(x[2]))) + 0.097626075), 0)
    h_1 = max((((-0.05875819 * float(x[0]))+ (-0.768332 * float(x[1]))+ (-0.08588248 * float(x[2]))) + -0.88293016), 0)
    o[0] = (-0.039134104 * h_0)+ (0.028108943 * h_1) + -0.17635962
