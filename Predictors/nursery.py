...
# Compile time: Feb-16-2020 13:35:31
# Invocation: btc -v -v nursery-1.csv -o nursery-1.py
# This source code requires Python 3.
#
"""
System Type:                        Binary classifier
Best-guess accuracy:                66.66%
Model accuracy:                     100.00% (12960/12960 correct)
Improvement over best guess:        33.34% (of possible 33.34%)
...
mappings = [{3799405578.0: 0, 540295165.0: 1, 3829549822.0: 2}, {569259139.0: 0, 1508046661.0: 1, 2375238695.0: 2, 1464146891.0: 3, 2831621946.0: 4}, {2107380400.0: 0, 1114099747.0: 1, 4177456500.0: 2, 989355118.0: 3}, {1.0: 0, 2.0: 1, 3.0: 2, 2337469052.0: 3}, {102786002.0: 0, 3393641315.0: 1, 1464146891.0: 2}, {3393641315.0: 0, 2419814605.0: 1}, {3009864811.0: 0, 3839293403.0: 1, 1442460959.0: 2}, {2323716607.0: 0, 1655102503.0: 1, 1602849391.0: 2}]
...
def classify(row):
    x=row
    h_0 = ((((0.8574278 * float(x[0]))+ (0.24829462 * float(x[1]))+ (0.28223938 * float(x[2]))+ (-0.48694336 * float(x[3]))+ (0.4155895 * float(x[4]))+ (0.72938496 * float(x[5]))+ (0.9855295 * float(x[6]))+ (-15.399099 * float(x[7]))) + 4.6085525))
    o_0=h_0
