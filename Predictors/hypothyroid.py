...
# Compile time: Mar-19-2020 23:27:29
# Invocation: btc -server brain.brainome.ai Data/hypothyroid.csv -o Models/hypothyroid.py -v -v -v -stopat 99.76 -port 8100 -f NN -e 10
...
def classify(row):
    ...
    o[0] = (-0.21587601 * h_0)+ (-1.200237 * h_1)+ (-6.4980135 * h_2) + 5.715536
