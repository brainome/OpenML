...
# Compile time: Mar-02-2020 11:43:05
# Invocation: btc Data/GAMETES_Heterogeneity_20atts_1600_Het_0.4_0.2_50_EDM-2_001.csv -o Models/GAMETES_Heterogeneity_20atts_1600_Het_0.py -v -v -v -stopat 100 -port 8090 -e 10
...
def classify(row):
    ...
    o_0 = (0.53428197 * h_0)+ (30.559582 * h_1)+ (1.4815677 * h_2)+ (-2.000755 * h_3)+ (28.492815 * h_4)+ (-2.16731 * h_5)+ (2.8594573 * h_6) + -0.3950811
