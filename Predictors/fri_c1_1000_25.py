...
# Compile time: Mar-19-2020 22:36:53
# Invocation: btc -server brain.brainome.ai Data/fri_c1_1000_25.csv -o Models/fri_c1_1000_25.py -v -v -v -stopat 90.90 -port 8100 -f NN -e 10
...
def classify(row):
    ...
    o[0] = (2.0512507 * h_0)+ (0.16135351 * h_1)+ (-3.3165047 * h_2)+ (10.678124 * h_3)+ (-8.606493 * h_4) + -3.6371121
